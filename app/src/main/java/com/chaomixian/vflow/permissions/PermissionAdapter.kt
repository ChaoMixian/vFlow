...
class PermissionAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (isGranted) {
            ...
            holder.status.setTextColor(MaterialColors.getColor(context, android.R.attr.colorPrimary, 0))
            ...
            holder.status.setTextColor(MaterialColors.getColor(context, android.R.attr.colorError, 0))
